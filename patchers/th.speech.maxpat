...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 59.5, 636.0, 71.0, 22.0 ],
					"text" : "fromsymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 178.0, 225.0, 66.0, 22.0 ],
					"text" : "route bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 180.0, 285.0, 64.0, 22.0 ],
					"text" : "zl.reg Alex"
				}
...
, 			{
				"box" : 				{
					"comment" : "(message) voice names for umenu",
					"id" : "obj-111",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"comment" : "(bang) when speech is done",
					"id" : "obj-110",
					"index" : 2,
					"maxclass" : "outlet",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 285.0, 59.0, 22.0 ],
					"text" : "round 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 420.0, 202.0, 22.0 ],
					"text" : "join"
				}
...
, 			{
				"box" : 				{
					"annotation" : "",
					"comment" : "(int) speaking rate in WordsPerMinute (default = 180)",
					"cool" : 1,
					"id" : "obj-100",
					"index" : 3,
					"maxclass" : "inlet",
...
, 			{
				"box" : 				{
					"annotation" : "",
					"comment" : "(int) speaking volume 0-100 (default = 25)",
					"cool" : 1,
					"id" : "obj-99",
					"index" : 2,
					"maxclass" : "inlet",
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 178.0, 60.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 60.0, 255.0, 39.0, 22.0 ],
					"text" : "/ 100."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 133.0, 285.0, 35.0, 22.0 ],
					"text" : "i 180"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "pkill" ],
					"patching_rect" : [ 59.5, 495.0, 42.0, 22.0 ],
					"text" : "t l pkill"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 450.0, 75.0, 22.0 ],
					"text" : "prepend say"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 735.0, 96.0, 22.0 ],
					"text" : "prepend append"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 120.0, 570.0, 51.0, 22.0 ],
					"text" : "t 1 clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 705.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 59.5, 665.0, 55.0, 22.0 ],
					"text" : "zl.slice 1"
				}
